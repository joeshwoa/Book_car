...
class InvoiceForFlexibleOfferAcceptedBottomSheetCustom extends StatelessWidget {

  final String id;
  final bool cardOnlinePayment;
  InvoiceForFlexibleOfferAcceptedBottomSheetCustom({super.key, required this.id, required this.cardOnlinePayment});
                    ...
                    Padding(
                      ...
                      child: MainButtonCustom(
                        onTap: () {
                          ...
                          cubit.changeInvoice(value: true);
                          context.pop();
                        },
