...
class AddNewDepartureDateForRebookView extends StatelessWidget {

  final bool timeSection;
  AddNewDepartureDateForRebookView({super.key, required this.timeSection,});
  ...
  Widget build(BuildContext context) {
    if (first) {
      ...
      cubit.updateStateLessPageVar(change: () {
        ...
        cubit.tempFocusedNewDate = cubit.newDate;
        cubit.tempSelectedNewDate = cubit.newDate;
        cubit.tempSelectedNewTime = cubit.newTime;
      },);
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if(cubit.tempAddDateTimePageIndex == 0)TableCalendar(
                                    focusedDay: cubit.tempFocusedNewDate,
                                    ...
                                    selectedDayPredicate: (day) =>isSameDay(day, cubit.tempSelectedNewDate),
                                    ...
                                    onDaySelected: (selectedDay, focusedDay) {
                                      cubit.updateStateLessPageVar(change: () {
                                        cubit.tempSelectedNewDate = selectedDay;
                                        cubit.tempFocusedNewDate = focusedDay;
                                      },);
                                    },
                                  ),
                                  if(cubit.tempAddDateTimePageIndex != 0)MediaQuery(
                                    ...
                                    child: TimePickerDialogCustom(
                                      initialTime: cubit.tempSelectedNewTime,
                                      onSubmit: (TimeOfDay selected) {
                                        cubit.updateStateLessPageVar(change: () {
                                          cubit.tempSelectedNewTime = selected;
                                        },);
                                      },
                                      onOk: (TimeOfDay selected) {
                                        ...
                                        cubit.changeNewDate(value: cubit.tempSelectedNewDate);
                                        cubit.changeNewTime(value: cubit.tempSelectedNewTime);
                                        cubit.updateStateLessPageVar(change: () {
                                          cubit.newDateTimeSelected = true;
                                        },);
                                      },
