...
/// See also:
///
/// * [showTimePicker], a function that shows a [TimePickerDialogCustom] and returns
            ...
            Row(
              children: <Widget>[
                ...
                if (hourDialType == _HourDialType.twelveHour && timeOfDayFormat != TimeOfDayFormat.a_space_h_colon_mm)
                  ...<Widget>[
                    Padding(
                      padding: EdgeInsets.only(right: SizeData.s12),
                      child: const _DayPeriodControl(),
                    ),
                  ],
              ],
            ),
              ...
              Column(
                ...
                children: <Widget>[
                  if (hourDialType == _HourDialType.twelveHour && timeOfDayFormat == TimeOfDayFormat.a_space_h_colon_mm)
                    const _DayPeriodControl(),
                  Padding(
                    padding: EdgeInsets.only(bottom: hourDialType == _HourDialType.twelveHour ? SizeData.s12 : 0),
                    child: Row(
                      // Hour/minutes should not change positions in RTL locales.
                      textDirection: TextDirection.ltr,
                      children: <Widget>[
...
class _HourMinuteControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      width: SizeData.s96,
      child: Material(
        color: MaterialStateProperty.resolveAs(ColorData.primaryColor500, states),
        ...
        child: GestureDetector(
          ...
          child: Center(
            child: Text(
              text,
              style: StyleData.textStylePrimary50R45,
      ...
      child: SizedBox(
        ...
        child: Center(
          child: Text(
            ...
            style: StyleData.textStyleGray200R45,
            textScaler: TextScaler.noScaling,
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
    ...
    switch (widget.hourMinuteMode) {
      case _HourMinuteMode.hour:
        return switch (widget.hourDialType) {
          _HourDialType.twentyFourHourDoubleRing => time.hour > 12 || time.hour == 0? 0 : 1,
  ...
  Widget build(BuildContext context) {
    ...
    final TimePickerThemeData timePickerTheme = TimePickerTheme.of(context);
    final _TimePickerDefaults defaultTheme = theme.useMaterial3 ? _TimePickerDefaultsM3(context) : _TimePickerDefaultsM2(context);
    final Color backgroundColor = ColorData.grayColor50;
    final Color dialHandColor = ColorData.blueColor400;
    final TextStyle labelStyle = StyleData.textStyleGray600R16;
...
class _TimePickerInputState extends State<_TimePickerInput> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: _TimePickerModel.useMaterial3Of(context) ? EdgeInsets.zero : EdgeInsets.symmetric(horizontal: SizeData.s16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Padding(padding: EdgeInsetsDirectional.only(bottom: _TimePickerModel.useMaterial3Of(context) ? SizeData.s20 : SizeData.s24),
            child: Text(
              widget.helpText,
              style: StyleData.textStyleGray400R16,
            ),
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            padding: EdgeInsets.only(bottom: SizeData.s10),
                          ...
                          if (!hourHasError.value && !minuteHasError.value)
                            ExcludeSemantics(
                              child: Text(
                                ...
                                style: StyleData.textStylePrimary800R12,
                                maxLines: 1,
          ...
          child: Semantics(
            ...
            child: TextFormField(
              ...
              decoration: inputDecoration.copyWith(
                fillColor: focusNode.hasFocus ? ColorData.primaryColor500 : ColorData.primaryColor300
              ),
...
/// [Navigator.pop].
///
/// Use [showTimePicker] to show a dialog already containing a [TimePickerDialogCustom].
class TimePickerDialogCustom extends StatefulWidget {
  /// Creates a Material Design time picker.
  const TimePickerDialogCustom({
    super.key,
  ...
  /// Restoration ID to save and restore the state of the [TimePickerDialogCustom].
  ///
...
class _TimePickerDialogCustomState extends State<TimePickerDialogCustom> with RestorationMixin {
  ...
  void _handleTimeChanged(TimeOfDay value) {
    if (value != _selectedTime.value) {
      ...
      if(widget.onSubmit != null) {
        widget.onSubmit!(_selectedTime.value);
      }
    }
  }
  ...
  void _handleOk() {
    ...
    if(widget.onOk != null) {
      widget.onOk!(_selectedTime.value);
    }
  ...
  Widget build(BuildContext context) {
                ...
                children: <Widget>[
                  TextButton(
                    ...
                    child: Text(widget.cancelText ??
                      ...
                      style: StyleData.textStylePrimary600M14,
                    ),
                  ),
                  TextButton(
    ...
    return Dialog(
      ...
      insetPadding: EdgeInsets.symmetric(
        horizontal: 16*0,
        vertical: (_entryMode.value == TimePickerEntryMode.input || _entryMode.value == TimePickerEntryMode.inputOnly) ? 0 : 0*24,
      ),
      child: Padding(
...
Future<TimeOfDay?> showTimePicker({
  ...
  final Widget dialog = TimePickerDialogCustom(
...
class _TimePickerDefaultsM3 extends _TimePickerDefaults {
  ...
  TextStyle get helpTextStyle {
    return MaterialStateTextStyle.resolveWith((Set<MaterialState> states) {
      ...
      return StyleData.textStyleGray400R16;
    });
  }
